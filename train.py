...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='C:/test/Smoke_Fire_Detection-main/weights/yolov5x.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='C:/test/Smoke_Fire_Detection-main/models/yolov5x.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='C:/test/Smoke_Fire_Detection-main/data0/fire_smoke.yaml', help='dataset.yaml path')
